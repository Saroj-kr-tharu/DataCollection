...
const Home = () => {
    ...
    // Check if all required fields are filled in all forms
            ...
            <div className="flex flex-col items-center py-8">
                ...
                <form onSubmit={handleSubmit} className="w-full max-w-3xl px-4">
                    ...
                    <div className="flex gap-4 justify-center mt-6">
                        ...
                        <button
                            type="submit"
                            className="bg-blue-600/80 hover:bg-blue-500/80 text-white font-semibold py-2 px-6 rounded-lg transition-all duration-200 flex items-center gap-2 backdrop-blur-sm"
                        >
                            <span>Submit</span>
                            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
